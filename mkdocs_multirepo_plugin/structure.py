...
class DocsRepo(Repo):
    ...
    async def import_docs(
        ...
        if self.multi_docs:
            ...
            # Convert /* to /** for sparse-checkout (/* is a plugin convention, ** is gitignore glob for recursive)
            # In --no-cone mode, sparse-checkout uses gitignore patterns where ** matches recursively
